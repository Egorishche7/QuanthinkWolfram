...
import translationsBy from '../locale/translations.by.json';
import translationsEn from '../locale/translations.en.json';
import translationsRu from '../locale/translations.ru.json';
