...
public class MatrixSumRequest extends CalculationRequest {
    private Matrix matrix1;
    private Matrix matrix2;
    private int threadsUsed;

    public MatrixSumRequest(long userId, ELibrary library, Matrix matrix1, Matrix matrix2, int threadsUsed) {
